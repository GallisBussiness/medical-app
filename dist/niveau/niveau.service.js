...
exports.NiveauService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const niveau_entity_1 = require("./entities/niveau.entity");
let NiveauService = class NiveauService {
    constructor(niveauModel) {
        this.niveauModel = niveauModel;
    }
    async create(createNiveauDto) {
        try {
    ...
    async update(id, updateNiveauDto) {
        try {
...
NiveauService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(niveau_entity_1.Niveau.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], NiveauService);
exports.NiveauService = NiveauService;
